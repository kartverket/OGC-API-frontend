...
export default function MapViewer({ collectionId, defaultBbox, crsOptions, baseUrl }) {
  ...
  function updateMapUrl(map, activeCrs) {
    ...
    const bbox = viewProj === targetProj ? extent : transformExtent(extent, viewProj, targetProj);
    setMapUrl(
      buildOgcMapsUrl(baseUrl, collectionId, { bbox, bboxCrs: activeCrs, crs: activeCrs, width: w, height: h }),
    );
  }
    ...
    <div className={styles.container}>
      <Card className={styles.controls}>
        ...
        <Field id="map-crs-field">
          ...
          <Select id="map-crs" value={crs} onChange={(e) => handleCrsChange(e.target.value)}>
            {crsOptions.map((c) => (
      ...
      <div className={styles.mapContainer}>
        ...
        <div className={styles.urlRow}>
          ...
          <button type="button" onClick={handleDownload} aria-label="Last ned kart" className={styles.iconButton}>
